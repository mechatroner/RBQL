...
class TestRBQLQueryParsing(unittest.TestCase):
    ...
    def test_column_name_parsing(self):
        select_part = 'a.hello'
        column_infos = prepare_and_parse_select_expression_to_column_infos(select_part)
        expected = [rbql_engine.QueryColumnInfo('a', None, 'hello', False, None, None)]
        self.assertEqual(expected, column_infos) 

        select_part = 'a.hello as my_hello'
        column_infos = prepare_and_parse_select_expression_to_column_infos(select_part)
        expected = [rbql_engine.QueryColumnInfo(None, None, None, False, 'my_hello', None)]
        self.assertEqual(expected, column_infos) 

        select_part = 'a1, a[2], a.hello, a["world"], NR, NF, something, foo(something, \'bar\'), "test", 3, 3 + 3, a.hello  as  my_hello , *, NR  AS MY_NR, a.*, b.*, b2'
        column_infos = prepare_and_parse_select_expression_to_column_infos(select_part)
        expected = [rbql_engine.QueryColumnInfo('a', 0, None, False, None, None), # a1
                    rbql_engine.QueryColumnInfo('a', 1, None, False, None, None), # a[2]
                    rbql_engine.QueryColumnInfo('a', None, 'hello', False, None, None), # a.hello
                    rbql_engine.QueryColumnInfo('a', None, 'world', False, None, None), # a["world"]
                    rbql_engine.QueryColumnInfo(None, None, 'NR', False, None, None), # NR
                    rbql_engine.QueryColumnInfo(None, None, 'NF', False, None, None), # NF
                    rbql_engine.QueryColumnInfo(None, None, 'something', False, None, None), # something 
                    None, # foo(something, 'bar')
                    None, # "test"
                    None, # 3
                    None, # 3 + 3
                    rbql_engine.QueryColumnInfo(None, None, None, False, 'my_hello', None), # as my_hello
                    rbql_engine.QueryColumnInfo(None, None, None, True, None, None), # *
                    rbql_engine.QueryColumnInfo(None, None, None, False, 'MY_NR', None), # as MY_NR
                    rbql_engine.QueryColumnInfo('a', None, None, True, None, None), # a.*
                    rbql_engine.QueryColumnInfo('b', None, None, True, None, None), # b.*
                    rbql_engine.QueryColumnInfo('b', 1, None, False, None, None), # b2
                   ]
        self.assertEqual(expected, column_infos) 
