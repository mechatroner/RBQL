...
class TestRBQLWithCSV(unittest.TestCase):
    ...
    def process_test_case(self, tmp_tests_dir, test_case):
        ...
        try:
            rbql_csv.query_csv(query, input_table_path, delim, policy, actual_output_table_path, out_delim, out_policy, encoding, warnings, with_headers, comment_prefix, strip_whitespaces=strip_whitespaces)
