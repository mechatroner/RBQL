...
def csv_main():
    ...
    parser.add_argument('--column-types', help='CSV list of column types, e.g. `str,int,float,str,json`. Default types: all str (can be converted inside the query e.g. `int(a1)`)')
