...
function build_engine_text(for_web) {
    ...
    let engine_body = replace_all(builder_text, marker, escape_string_literal_backtick(template_text)); // Using replace_all here because JS's built-in "replace" method is broken, see comment here: https://stackoverflow.com/a/288384/2898283 
    if (for_web) {
